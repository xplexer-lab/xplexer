...
// - Router is parametrized with generic. So colled container. Container in general is set of all infrastructure level dependencies. It also has to be used for execution transactions. I see the code next way.
...
// 	return nil, errors.NewRouter("something went wrong")
// }, ... )
